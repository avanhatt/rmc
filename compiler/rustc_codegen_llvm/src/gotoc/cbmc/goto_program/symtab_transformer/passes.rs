...
use super::gen_c_transformer::{
    ExprTransformer, NameTransformer, NondetTransformer, ParameterSymbolTransformer,
};
...
pub fn do_passes(mut symtab: SymbolTable, pass_names: &[String]) -> SymbolTable {
    for pass_name in pass_names {
        ...
        //     "parameter" => ParameterSymbolTransformer::transform(&symtab),
        //     _ => panic!("Invalid symbol table transformation: {}", pass_name),
        // }
        symtab = ParameterSymbolTransformer::transform(&symtab);
    }
