...
def compile_single_rust_file(input_filename, output_filename, verbose=False, debug=False, keep_temps=False, mangler="v0", dry_run=False, symbol_table_passes=SYMBOL_TABLE_PASSES):
    if not keep_temps:
